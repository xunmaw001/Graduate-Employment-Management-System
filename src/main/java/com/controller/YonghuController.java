...
public class YonghuController {
    ...
    */
    @RequestMapping("/save")
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request) throws ParseException {
        ...
        if(yonghuEntity==null){
            ...
            Date parse = format.parse(yonghu.getIdNumber().substring(6, 14));
            if(parse.getTime() < format.parse("19500101").getTime() || parse.getTime() > new Date().getTime()){
                ...
                yonghu.setChushengriqi(chushengriqi.toString());
            }
    ...
    */
    ...
    public R update(@RequestBody YonghuEntity yonghu, HttpServletRequest request) throws ParseException {
    ...
    */
    ...
    public R zhaohui(@RequestBody Map<String,String> map, HttpServletRequest request){
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("username", String.valueOf(map.get("username"))).eq("name", String.valueOf(map.get("name"))).eq("phone", String.valueOf(map.get("phone"))).eq("id_number", String.valueOf(map.get("idNumber"))));
        if(yonghuEntity != null){
