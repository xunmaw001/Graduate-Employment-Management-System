...
public class JigouEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Jigou{" +
            ...
            ", jigouChushengriqi=" + jigouChushengriqi +
            ", jigouNation=" + jigouNation +
            ", politicsTypes=" + politicsTypes +
            ", danwei=" + danwei +
            ", bumenTypes=" + bumenTypes +
            ", zhiweiTypes=" + zhiweiTypes +
            ", jigouIdNumber=" + jigouIdNumber +
            ", jigouPhone=" + jigouPhone +
            ", jigouAddress=" + jigouAddress +
            ", jigouYouzhengbianma=" + jigouYouzhengbianma +
            ", jigouAihaoContent=" + jigouAihaoContent +
