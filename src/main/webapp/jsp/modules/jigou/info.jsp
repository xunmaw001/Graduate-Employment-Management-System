            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">机构人员登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouName" name="jigouName" class="form-control"
                                               v-model="ruleForm.jigouName" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>照片</label>
                                    <img id="jigouPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>出生日期</label>
                                        <input id="jigouChushengriqi" name="jigouChushengriqi" class="form-control"
                                               v-model="ruleForm.jigouChushengriqi" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouNation" name="jigouNation" class="form-control"
                                               v-model="ruleForm.jigouNation" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouIdNumber" name="jigouIdNumber" class="form-control"
                                               v-model="ruleForm.jigouIdNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouPhone" name="jigouPhone" class="form-control"
                                               v-model="ruleForm.jigouPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouAddress" name="jigouAddress" class="form-control"
                                               v-model="ruleForm.jigouAddress" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="jigouYouzhengbianma" name="jigouYouzhengbianma" class="form-control"
                                               v-model="ruleForm.jigouYouzhengbianma" readonly>
                                    </div>
        ...
        if (ruleForm.jigouAihaoContent != null && ruleForm.jigouAihaoContent != 'null' && ruleForm.jigouAihaoContent != '') {
            var jigouAihaoContentUeditor = UE.getEditor('jigouAihaoContentEditor');
                jigouAihaoContentUeditor.ready(function () {
                    ...
                    jigouAihaoContentUeditor.setDisabled('fullscreen');
            });
        }
    }
