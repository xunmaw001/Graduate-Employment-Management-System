            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">就业信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="chushengriqi" name="chushengriqi" class="form-control"
                                                   v-model="ruleForm.chushengriqi" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="banji" name="banji" class="form-control"
                                                   v-model="ruleForm.banji" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xuehao" name="xuehao" class="form-control"
                                                   v-model="ruleForm.xuehao" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="youzhengbianma" name="youzhengbianma" class="form-control"
                                                   v-model="ruleForm.youzhengbianma" readonly>
                                        </div>


                                    <div>
                                        <label>个人爱好</label>
                                        <script id="aihaoContentEditor" type="text/plain"
                                                style="width:800px;height:230px;"></script>
                                        <script type = "text/javascript" >
                                        //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
                                        //相见文档配置属于你自己的编译器
                                        var aihaoContentUe = UE.getEditor('aihaoContentEditor', {
                                            toolbars: [
                                                [
                                                    'undo', //撤销
                                                    'bold', //加粗
                                        ...
                                        <input type="hidden" name="aihaoContent" id="aihaoContent-input">
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="gongsiName" name="gongsiName" class="form-control"
                                               v-model="ruleForm.gongsiName" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.aihaoContent != null && ruleForm.aihaoContent != 'null' && ruleForm.aihaoContent != '') {
            var aihaoContentUeditor = UE.getEditor('aihaoContentEditor');
                aihaoContentUeditor.ready(function () {
                    var mes = '' + ruleForm.aihaoContent;
                    aihaoContentUeditor.setContent(mes);
                    aihaoContentUeditor.setDisabled('fullscreen');
            });
        }
