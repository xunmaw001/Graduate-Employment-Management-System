    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">地区毕业生统计</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">地区毕业生管理</li>
                        <li class="breadcrumb-item active">地区毕业生统计</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function getDetails() {
        //填充下拉框选项
        http("/count/group/jiuye/diqu_types", "GET", null, (res) => {
            if(res.code == 0){
            draw(res.data);
        }
    });
